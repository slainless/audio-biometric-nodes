...
class SpeakerWavLMEmbedder(VoiceEmbedder):
    def __init__(self, embedding_source: EmbeddingSource) -> None:
        self.source = embedding_source
        self.model = EmbeddingsModel.from_pretrained("Orange/Speaker-wavLM-id")
        self.model.eval()
